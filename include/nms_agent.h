...
#define DCIDESC_SYSTEM_HARDWARE_MANUFACTURER      _T("Hardware manufacturer")
#define DCIDESC_SYSTEM_HARDWARE_PRODUCT           _T("Hardware product name")
#define DCIDESC_SYSTEM_HARDWARE_SERIALNUMBER      _T("Hardware serial number")
#define DCIDESC_SYSTEM_HARDWARE_VERSION           _T("Hardware version")
#define DCIDESC_SYSTEM_HARDWARE_WAKEUPEVENT       _T("Hardware wakeup event")
