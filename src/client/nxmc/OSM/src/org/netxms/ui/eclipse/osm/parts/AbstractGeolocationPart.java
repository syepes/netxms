...
/**
 * Base class for all geographical parts
 */
public abstract class AbstractGeolocationPart implements ISelectionProvider
{
	...
	{      
		...
		map.addMapListener(new GeoMapListener() {
			...
			{
				AbstractGeolocationPart.this.zoomLevel = zoomLevel;
				mapAccessor.setZoom(zoomLevel);
