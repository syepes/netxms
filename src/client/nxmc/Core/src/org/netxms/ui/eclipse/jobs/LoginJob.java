...
import org.netxms.ui.eclipse.core.Activator;
import org.netxms.ui.eclipse.core.Messages;
   ...
   public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException
   {
      ...
      try
      {
         ...
         display.syncExec(new Runnable() {
            ...
            public void run()
            {
               SourceProvider sp = SourceProvider.getInstance();
               if (sp != null)
                  sp.updateAccessRights(session.getUserSystemRights());
            }
         });
