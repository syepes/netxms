...
{
	private static final String BUNDLE_NAME = "org.netxms.ui.eclipse.core.messages"; //$NON-NLS-1$
   ...
   public static String AbstractTraceView_Unsubscribing;
	public static String BrandingManager_ConsoleProductName;
   ...
   public static String DataCollectionDisplayInfo_Counter32;
   public static String DataCollectionDisplayInfo_Counter64;
